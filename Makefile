...
.PHONY: help db-reset migrations-sync collections-snapshot collections-sync seed-collection
...
collections-snapshot: ## Create a snapshot migration of current collections schema
